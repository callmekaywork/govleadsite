      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-brand-card-bg p-12 border-4 border-black shadow-[6px_6px_0px_#000] rounded-[3rem] space-y-8"
          >
            <div className="space-y-4">
              <span className="inline-block px-4 py-1 bg-black text-white font-mono text-[10px] uppercase font-bold rounded-lg">
                Compatibility Check
              </span>
              <h2 className="text-4xl md:text-5xl font-sans font-black text-default-text uppercase tracking-tighter leading-none">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="flex flex-col justify-center p-12 border-4 border-black bg-brand-card-comp-bg shadow-[6px_6px_0px_#000] rounded-[3rem] space-y-8"
          >
            <div className="space-y-4">
              <h3 className="text-3xl font-sans font-black text-default-text uppercase tracking-tighter leading-none">
                Wait. <br />
            ...
            <div className="pt-8 block">
              <button
                ...
                className="w-full py-6 bg-black text-white font-sans font-black uppercase tracking-widest hover:bg-zinc-800 transition-colors rounded-2xl shadow-[4px_4px_0px_#525252] cursor-pointer"
              >
                Check Alignment
              </button>
            </div>
