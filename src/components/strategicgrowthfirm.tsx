...
export default function Strategicgrowthfirm() {
  return (
    <section
      ...
      className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch max-w-400 px-4 md:px-0"
    >
      <div className="lg:col-span-8 border-4 border-black bg-brand-card-acc-bg p-8 md:p-12 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] flex flex-col justify-between rounded-2xl ">
        <div className="space-y-15">
          <div className="font-mono text-xs text-emerald-800 uppercase font-black tracking-widest   px-3 py-1 w-max rounded-lg"></div>
          <h2 className="text-3xl md:text-4xl font-black text-default-text tracking-tight leading-tight">
            A Strategic Growth Firm Built for Modern Business Complexity.
          </h2>
          <p className="text-brand-text leading-relaxed font-sans text-base max-w-3xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 font-mono text-sm uppercase">
            {[
              ...
              <div
                key={idx}
                className="flex items-center gap-2 bg-brand-card-bg border-2 border-brand-card-comp-bg p-3 font-extrabold shadow-[2px_2px_0px_0px_#000] rounded-xl"
              >
        ...
        <div className="mt-8 pt-8 border-t-2 border-black/20 text-accent-text italic">
