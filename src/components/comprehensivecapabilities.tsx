    ...
    <div className="max-w-400 px-4 md:px-0">
      <section id="capabilities-segment" className="mt-20 space-y-18">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
          ...
          <p className="text-accent-text text-sm md:text-base leading-relaxed font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="border-4 border-black bg-brand-card-comp-bg p-6 md:p-8 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] rounded-2xl space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
              <div className="border-2 border-black w-14 h-14 bg-[#2563EB] text-default-text flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] rounded-xl">
                <Target className="w-8 h-8 stroke-[2.5px] text-white" />
              </div>

              <h3 className="font-mono text-lg uppercase font-black text-default-text">
                GOVLEAD STRATEGY
              </h3>
              <p className="text-xs text-accent-text font-sans leading-relaxed">
            ...
            <div className="space-y-3 border-t-2 border-black pt-6">
              <span className="font-mono text-[10px] font-black uppercase text-brand-text tracking-wider">
                CORE SERVICES:
              </span>
              <ul className="space-y-2 text-xs font-mono text-neutral-850">
                {[
                  ...
                  <li key={i} className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 bg-brand-bacground border border-brand-bacground  inline-block rounded-sm"></span>
                    <span>{srv}</span>
                  </li>
                ))}
              </ul>
          ...
          {/* CAPABILITY 2: GROWTH */}
          <div className="border-4 border-black bg-brand-card-bg p-6 md:p-8 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] rounded-2xl space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
