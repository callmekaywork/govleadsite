...
export default function Consultations() {
  return (
    <div className="mt-20 max-w-400">
      {/* SECTION 9 — FINAL CTA */}
      <section
        id="homepage-final-cta"
        className="border-4 border-black bg-[#2563EB] p-8 md:p-16 text-center space-y-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden text-white rounded-3xl"
      >
