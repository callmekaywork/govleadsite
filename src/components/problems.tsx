    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
        ...
        <div className="lg:col-span-7 space-y-20">
          <div className="space-y-15">
            <h2 className="text-3xl md:text-5xl lg:text-6xl text-defau;t-text font-black uppercase leading-[1.1] tracking-tight">
              ...
              <span className="italic font-light text-black bg-brand-bacground px-4 py-1.5 inline-block border-[3px] border-black rounded-2xl shadow-[4.5px_4.5px_0px_#000] mt-3">
          ...
          {/* Supporting Heading */}
          <div className="border-l-[5px] border-black pl-5 space-y-2">
            <p className="text-xl md:text-2xl font-serif text-default-text font-black ">
              They struggle because growth systems are fragmented.
            </p>
          </div>

          {/* Copy Direction Narrative */}
          <div className="space-y-6 text-sm md:text-base text-black/85 font-semibold leading-relaxed max-w-2xl">
            <p>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-[#FAF9F5] border-[3px] border-black p-8 rounded-3xl shadow-[6px_6px_0px_#000] space-y-6 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[radial-gradient(rgba(0,0,0,0.03)_1px,transparent_1px)] [background-size:10px_10px] opacity-30"></div>

            <div className="space-y-4">
              <h4 className=" text-lg font-black  text-[#000]">
                The Symptoms of Systemic Drag
              </h4>
              <p className="text-xs text-[#000]/60 font-semibold leading-relaxed">
            ...
            <div className="space-y-3.5 pt-2">
              <div className="flex items-start bg-white border-[2.5px] border-black p-4 rounded-2xl shadow-[3px_3px_0px_#000] transition-transform hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[4.5px_4.5px_0px_#000]">
                ...
                <div>
                  <h5 className="text-xs text-black font-black uppercase tracking-wider font-mono">
              ...
              <div className="flex items-start bg-white border-[2.5px] border-black p-4 rounded-2xl shadow-[3px_3px_0px_#000] transition-transform hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[4.5px_4.5px_0px_#000]">
                <div className="bg-orange-100 border-[1.5px] border-black p-2 rounded-xl text-black shrink-0 mr-4 shadow-[1.5px_1.5px_0px_#000]">
