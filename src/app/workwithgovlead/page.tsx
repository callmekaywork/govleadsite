...
export default function Workwithgovlead() {
  return (
    <main className="min-h-screen bg-background w-full flex flex-1 flex-col items-center">
      <Logo_nav />
      <Navigation />
      <div id="work-with-us-view" className="space-y-12 max-w-400">
        {/* Header intro */}
        <div className="border-4 border-black bg-[#E8F8F5] p-8 md:p-12 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] space-y-4 rounded-3xl">
          ...
          <p className="text-xs md:text-sm text-neutral-700 max-w-2xl leading-relaxed font-sans">
            ...
            Dissect your growth gaps and calibrate alignment using our real-time
            simulation diagnostic utility below.
          </p>
        </div>

        {/* Structured Pre-Engagement information cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="border-4 border-black bg-white p-6 shadow-[4px_4px_0px_0px_#000] space-y-4 rounded-2xl">
            <span className="font-mono text-xs text-neutral-400 font-extrabold block">
              CRITERION_01
            </span>
            <h3 className="font-mono text-sm uppercase font-black text-black">
              Who We Work Best With
            </h3>
            <p className="text-xs text-neutral-600 font-sans leading-relaxed">
              Founder-led companies and mid-tier enterprises doing between $2M
              and $30M in annual revenue, operating with long-term partnership
              timelines.
            </p>
          </div>
          ...
          <div className="border-4 border-black bg-white p-6 shadow-[4px_4px_0px_0px_#000] space-y-4 rounded-2xl">
            ...
            <p className="text-xs text-neutral-600 font-sans leading-relaxed">
              ...
              We do not operate on purely tactical scopes unless accompanied by
        ...
        <div className="border-4 border-black bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-3xl overflow-hidden">
          <div className="bg-[#2563EB] text-white border-b-4 border-black p-4 md:p-6 flex items-center justify-between">
            <div className="flex items-center gap-2">
              {/* <Activity className="w-6 h-6 stroke-[3px] text-white" /> */}
              <span className="font-mono text-xs md:text-sm uppercase font-black tracking-wider text-white">
          ...
          <div className="p-6 md:p-10">
            <p className="text-xs text-neutral-600 max-w-3xl leading-relaxed mb-6">
              Input your business parameters below. Our server-side integration
              will query GovLead&apos;s Gemini Framework Core, analyze your
              qualitative constraints, and return a comprehensive Systems
              Blueprint scorecard.
            </p>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-mono text-xs">
                <div className="space-y-2">
                  <label className="font-bold text-black uppercase">
                    Company Name
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full bg-neutral-50 text-black border-2 border-black p-3 font-semibold focus:bg-white outline-none rounded-xl"
                    required
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full bg-white text-black border-2 border-black p-3 font-semibold outline-none rounded-xl cursor-pointer"
                  >
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full bg-neutral-50 text-black border-2 border-black p-3 font-sans font-medium focus:bg-white outline-none rounded-xl"
                    required
                  />
                </div>
              </div>
